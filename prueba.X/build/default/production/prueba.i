...
config_io:
 ...
 config_tmr0:
    ...
    bcf ((OPTION_REG) and 07Fh), 5 ; reloj interno clock selection
    bcf ((OPTION_REG) and 07Fh), 3 ;Prescaler
    bsf ((OPTION_REG) and 07Fh), 2
    bsf ((OPTION_REG) and 07Fh), 1
    bsf ((OPTION_REG) and 07Fh), 0 ;PS = 111 Tiempo en ejecutar , 256
 ...
 config_reloj:
    ...
    bsf ((OSCCON) and 07Fh), 6 ;OSCCON configuración bit2 IRCF
    bsf ((OSCCON) and 07Fh), 5 ;OSCCON configuracuón bit1 IRCF
    bcf ((OSCCON) and 07Fh), 4 ;OSCCON configuración bit0 IRCF
    bsf ((OSCCON) and 07Fh), 0 ;reloj interno , 4Mhz
    return

config_InterrupEnable:
    bsf ((INTCON) and 07Fh), 7 ;Habilitar en general las interrupciones, Globales
    bsf ((INTCON) and 07Fh), 3 ;Se encuentran en INTCON
    bcf ((INTCON) and 07Fh), 0 ;Limpiamos bandera
